...
# Cfg.train_label = '/media/4TDisk/zzl/datasets/Github_data/cityscape_fake_cyclegan_with_foggy/VOC2007/ImageSets/Main/train_combine_fg.txt'
Cfg.train_label = os.path.join(_BASE_DIR, 'temp.txt')
