...
class cityscape(imdb):
    def __init__(self, image_set, year, devkit_path=None, imdb_name = None):
        imdb.__init__(self, 'cs_' + year + '_' + image_set) if imdb_name is None \
            else imdb.__init__(self, imdb_name + year + '_' + image_set)
        self._year = year
    ...
    def _get_default_path(self):
        ...
        """
        return os.path.join(cfg.DATA_DIR, 'cityscape_fake_cyclegan_with_foggy')
