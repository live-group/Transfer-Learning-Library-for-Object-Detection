...
def parse_args():
    ...
    parser.add_argument('--log_ckpt_name', dest='log_ckpt_name',
                        ...
                        default='cs_combine_fg2cs_fg_combine_cs', type=str)
    ...
    parser.add_argument('--save_dir', dest='save_dir',
                        help='directory to save models', default="./output/model",
                        type=str)
...
def set_dataset_args(args, test=False):
    if not test:
        if args.dataset == "hos":
            ...
            args.set_cfgs = ['ANCHOR_SCALES', '[4, 8, 16, 32]', 'ANCHOR_RATIOS', '[0.5,1,2]', 'MAX_NUM_GT_BOXES', '20']
        elif args.dataset == "cs_combine_fg_combine_mosaic":
            args.imdb_name = "cs_2007_train_combine_fg_combine_mosaic"
            args.set_cfgs = ['ANCHOR_SCALES', '[4, 8, 16, 32]', 'ANCHOR_RATIOS', '[0.5,1,2]', 'MAX_NUM_GT_BOXES', '20']
        ...
        elif args.dataset_t == "cs_fg_combine_cs":
            args.imdb_name_target = "cs_fg_2007_train_combine_cs"
        elif args.dataset_t == "cs_fg_combine_cs_combine_mosaic":
            args.imdb_name_target = "cs_fg_2007_train_combine_cs_combine_mosaic"
        ...
        if args.dataset_t == "hos":
            ...
            args.set_cfgs_target = ['ANCHOR_SCALES', '[4, 8, 16, 32]', 'ANCHOR_RATIOS', '[0.5,1,2]', 'MAX_NUM_GT_BOXES', '20']
        elif args.dataset_t == "inb":
            args.imdb_name_target = "inb_2007_trainval"
            args.set_cfgs_target = ['ANCHOR_SCALES', '[4, 8, 16, 32]', 'ANCHOR_RATIOS', '[0.5,1,2]', 'MAX_NUM_GT_BOXES', '20']
        elif args.dataset_t == "clipart":
            ...
            args.imdb_name_target = "cityscape_2007_test_t"
            args.set_cfgs_target = ['ANCHOR_SCALES', '[4, 8, 16, 32]', 'ANCHOR_RATIOS', '[0.5,1,2]', 'MAX_NUM_GT_BOXES', '20']
            ...
            args.imdb_name_target = "kitti_car_2007_trainval"
            args.set_cfgs_target = ['ANCHOR_SCALES', '[4, 8, 16, 32]', 'ANCHOR_RATIOS', '[0.5,1,2]', 'MAX_NUM_GT_BOXES',
                                    '20']
    ...
    args.cfg_file = cfg.ROOT_DIR + "/lib/IDF/{}_ls.yml".format(args.net) if args.large_scale else cfg.ROOT_DIR + "/lib/IDF/{}.yml".format(args.net)
