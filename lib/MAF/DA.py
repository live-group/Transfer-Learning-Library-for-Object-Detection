...
from MAF.drm import DRM        # Scale Reduce Module (SRM)
from MAF.LabelResizeLayer import ImageLabelResizeLayer
from MAF.LabelResizeLayer import InstanceLabelResizeLayer
