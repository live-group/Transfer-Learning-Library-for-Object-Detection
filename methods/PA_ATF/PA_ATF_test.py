...
if __name__ == '__main__':
  ...
  for i in range(num_images):
      ...
      with torch.no_grad():
          ...
          cur_time.append(curr_time)

#      stat(fasterRCNN, (im_data, im_info, gt_boxes, num_boxes))
...
#      stat(fasterRCNN, (im_data, im_info, gt_boxes, num_boxes))
      ...
      test_time.append(nms_time)
      # print("i: %d, time: %f"% (i, nms_time))
  ...
  print("average time: %0.4fs" % np.mean(test_time))
  print("curr_time time: %0.4fms" % np.mean(cur_time))
