...
from roi_data_layer.roidb import combined_roidb
from MAF.roibatchLoader import roibatchLoader
...
from MAF.vgg16 import vgg16
from MAF.resnet import resnet
    ...
    for step in range(iters_per_epoch):
      ...
      loss = rpn_loss_cls.mean() + rpn_loss_box.mean() \
           + RCNN_loss_cls.mean() + RCNN_loss_bbox.mean() \
             +args.lamda*(DA_img_loss_cls.mean()+args.alpha* DA_ins_loss_cls.mean()\
             + tgt_DA_img_loss_cls.mean()+args.alpha* tgt_DA_ins_loss_cls.mean())
      loss_temp += loss.item()
